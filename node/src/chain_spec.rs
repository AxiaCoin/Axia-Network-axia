  ...
  Ok(ChainSpec::from_genesis(
    ...
    move || testnet_genesis(
      ...
      vec![
        ...
        // subkey inspect "$SECRET//axia//1//validator"
        // subkey inspect "$SECRET//axia//1//babe"
        // subkey inspect --scheme ed25519 "$SECRET//axia//1//grandpa"
        // subkey inspect "$SECRET//axia//1//imonline"
        // subkey inspect "$SECRET//axia//1//discovery"
        /*
        (
        ...
        // subkey inspect "$SECRET//axia//2//validator"5FNQoCoibJMAyqC77og9tSbhGUtaVt51SD7GdCxmMeWxPBvX
        // subkey inspect "$SECRET//axia//2//babe"
        // subkey inspect --scheme ed25519 "$SECRET//axia//2//grandpa"
        // subkey inspect "$SECRET//axia//2//imonline"
        // subkey inspect "$SECRET//axia//2//discovery"
        (
        ...
        // subkey inspect "$SECRET//axia//3//validator"
        // subkey inspect "$SECRET//axia//3//babe"
        // subkey inspect --scheme ed25519 "$SECRET//axia//3//grandpa"
        // subkey inspect "$SECRET//axia//3//imonline"
        // subkey inspect "$SECRET//axia//3//discovery"
        (
      ...
      // subkey inspect "$SECRET//axia//root"
    ...
    // Bootnodes
    vec![
      "/dns/seed1.rose-cc2.axianode.com/tcp/30333/p2p/12D3KooWPb5VY3dzydLFVh4Bn8sk73QvicvVoYcHQawRgicuMNwJ"
        .parse()
        .unwrap(),
      "/dns/seed2.rose-cc2.axianode.com/tcp/30333/p2p/12D3KooWG4jPV345wrEE23tdRh69i9YH5BtSo8RhToPj4fTaJgkZ"
        .parse()
        .unwrap(),
    ],
    // Telemetry
...
pub fn iris_testnet_config() -> Result<ChainSpec, String> {
  ...
  Ok(ChainSpec::from_genesis(
    ...
    // Bootnodes
    vec![
      "/dns/seed1.iris-cc2.axia.finance/tcp/30333/p2p/12D3KooWFtshqoFL1hAwseGc4WuFeREKicjFR15JiVEaJiHnDvn2"
        .parse()
        .unwrap(),
      "/dns/seed2.iris-cc2.axia.finance/tcp/30333/p2p/12D3KooWBcU1EShS2azLwQhKVKyeXU2cc3CWyhuN8wJwEKaRVNe8"
        .parse()
        .unwrap(),
    ],
    // Telemetry
