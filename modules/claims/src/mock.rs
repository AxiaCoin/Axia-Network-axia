...
parameter_types! {
    pub Prefix: &'static [u8] = b"Pay AXCs to the TEST account:";
...
pub fn get_legal_eth_sig() -> EcdsaSignature {
  ...
  // data: Pay AXCs to the TEST account:01000000000000004c5adaad6ca9cd2ae9f372b59ff6765fb66082c08caf6e61e6fbc39c35e82bec
...
pub fn get_wrong_msg_eth_sig() -> EcdsaSignature {
  ...
  // data: Pay AXCs to the TEST account2:010000000000000
