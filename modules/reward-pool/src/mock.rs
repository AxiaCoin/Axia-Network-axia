...
parameter_types! {
  pub const GetNativeCurrencyId: CurrencyId = CurrencyId::AXC;
}
...
parameter_types! {
  pub const RewardPoolModuleId: ModuleId = ModuleId(*b"axc/repm");
}
  ...
  fn default() -> Self {
    ...
    Self {
      endowed_accounts: vec![
        (alice.clone(), AXC, 1_000_000_000_000_000_000u128),
        (bob.clone(), AXC, 1_000_000_000_000_000_000u128),
  ...
  pub fn build(self) -> sp_io::TestExternalities {
    ...
    pallet_balances::GenesisConfig::<TestRuntime> {
      balances: self
        ...
        .clone()
        .into_iter()
        .filter(|(_, currency_id, _)| *currency_id == AXC)
