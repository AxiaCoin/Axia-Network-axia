...
features:
- title: EVM Contract
  details: Axia allows you to run EVM contracts natively in Substrate, tightly integrated with the rest of the Substrate ecosystem.
...
- title: Substrate Module
  details: Axia can be easily integrated in your existing Substrate application as a runtime module.
footer: Made by Parity & Wei & PureStake with ❤️
---

Axia is the suite that provides an Ethereum compatibility layer
