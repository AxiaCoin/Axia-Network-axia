...
#[cfg(feature = "axia-mainnet")]
const CHAIN_ID: u64 = 4000;
#[cfg(feature = "axia-testnet")]
const CHAIN_ID: u64 = 4001;

parameter_types! {
  pub const ChainId: u64 = 4000;
}

static AXIA_EVM_CONFIG: evm::Config = axia_evm_config::AxiaEvmConfig::config();
...
parameter_types! {
  ...
  pub const BondingDuration: pallet_staking::EraIndex = 28; // 28 era for unbouding (48 * 6 hours)
  pub const SlashDeferDuration: pallet_staking::EraIndex = 27; // 1/2 bonding duration
...
parameter_types! {
  ...
  pub const ClaimsModuleId: ModuleId = ModuleId(*b"axcclaim");
}

impl axia_claims::Config for Runtime {
...
impl axia_evm_interop::Config for Runtime {
    type Event = Event;
    type Currency = Balances;
    type AddressMapping = EvmAddressMapping<Runtime>;
}
...
construct_runtime!(
    ...
    UncheckedExtrinsic = UncheckedExtrinsic
  {
    ...
    AxiaClaims: axia_claims::{Module, Call, Storage, Event<T>, ValidateUnsigned},
    AxiaEvminterop: axia_evm_interop::{Module, Call, Storage, Event<T>},
  }
);
