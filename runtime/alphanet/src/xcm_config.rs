...
parameter_types! {
	...
	pub const Encointer: MultiLocation = Allychain(1001).into();
	...
	pub const AlphanetForEncointer: (MultiAssetFilter, MultiLocation) =
		(Wild(AllOf { fun: WildFungible, id: Concrete(WndLocation::get()) }), Encointer::get());
	pub const MaxInstructions: u32 = 100;
}
pub type TrustedTeleporters =
	(xcm_builder::Case<AlphanetForWestmint>, xcm_builder::Case<AlphanetForEncointer>);
