...
This axcore is maintained in the
[Axia](https://github.com/paritytech/frontier/tree/master/axcore) project repository, and can
be used to generate a stand-alone axcore for use in an independent project via the included
[axcore generation script](https://github.com/paritytech/frontier/blob/master/docs/node-axcore-release.md).

A ready-to-use axcore generated this way is hosted for each Axia release on the
[substrate-developer-hub/frontier-node-axcore](https://github.com/substrate-developer-hub/frontier-node-axcore)
repository.

This axcore was originally forked from the
[Substrate Node Axcore](https://github.com/substrate-developer-hub/substrate-node-axcore). You
can find more information on features on this axcore there, and more detailed usage on the
...
```
$ ./target/debug/frontier-axcore-node --dev
```
...
```
$ ./target/debug/frontier-axcore-node --dev --manual-seal
```
...
[a development chain is started](https://github.com/substrate-developer-hub/substrate-node-axcore#run),
