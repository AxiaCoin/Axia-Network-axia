...
pub use axia_rpc_runtime_api::CurrencyExchangeApi as CurrencyExchangeRuntimeApi;
...
pub trait CurrencyExchangeRpc<BlockHash, AccountId, CurrencyId, Balance, Rate, Share> {
  #[rpc(name = "axia_targetAmountAvailable")]
  ...
  #[rpc(name = "axia_supplyAmountNeeded")]
  ...
  #[rpc(name = "axia_getExchangeRate")]
  fn get_exchange_rate(&self, at: Option<BlockHash>) -> Result<Rate>;

  #[rpc(name = "axia_toAddLiquidity")]
  ...
  #[rpc(name="axia_getAccountStakingInfo")]
